        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 font-sans">
                    <form method="POST" action="{{ route('tenant.admin.categories.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            <x-input-label for="order_position" :value="__('Orden (Opcional)')" />
                            <x-text-input id="order_position" name="order_position" type="number" class="mt-1 block w-full" :value="old('order_position', 0)" />
